...
export default function MainDisplay({onAdded}) {
    return (
        <section id="main-container" className="p-6 items-center text-center min-w-max mx-auto my-48">
            ...
            <p>
                <button className="p-2.5 rounded-lg text-gray-200 bg-black bg-opacity-75 transform duration-500 hover:bg-opacity-85 hover:text-white text-base font-medium" onClick={() => onAdded(true)}>Create new project</button>
            </p>
        </section>
    );
}