        ...
        <dialog ref={dialog} className="rounded-lg box-border shadow-lg ">
            ...
            <div className="w-auto h-12 bg-black bg-opacity-75 text-right">
                <button className="px-4 py-4">
                    <img src={close} alt="close" className="w-4 h-4 transform duration-500 hover:rotate-180 xl:w-5 xl:h-5"/>
                </button>
            </div>
            <div className="pt-6 px-12 pb-8 w-[30rem]">
                ...
                <p className="text-center xl:text-xl">The project '{projectTitle}' will be deleted without the possibility of return</p>
                <img src={basket} alt="basket-photo" className="w-28 h-30 mx-auto my-2 xl:w-32 xl:h-36"/>
